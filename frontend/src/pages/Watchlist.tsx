...
const WatchlistRow: React.FC<{
  ...
  onUpdate: (symbol: string, buy: number | null, sell: number | null, note: string | null) => void;
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="w-40 min-w-0">
          <Link
            ...
            className="font-semibold text-gray-900 dark:text-gray-100 hover:text-teal-600 dark:hover:text-teal-400 transition-colors truncate block"
          >
        ...
        <div className="w-32 flex-shrink-0">
          ...
          <div className="flex items-center gap-1">
            ...
            <input
              ...
              placeholder="—"
              className="w-full text-sm border border-gray-200 dark:border-gray-600 rounded px-2 py-1 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-teal-500"
            />
          </div>
          {diffToBuy !== null && (
        ...
        {/* Added date */}
        <div className="flex-1 text-xs text-gray-400 dark:text-gray-500 text-center hidden sm:block">
          {addedDate}
        </div>
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="ml-1 text-sm text-gray-400 dark:text-gray-500">{items.length} {items.length === 1 ? 'company' : 'companies'}</span>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {/* Column headers */}
          <div className="flex items-center gap-3 px-4 py-1 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wide">
            <div className="w-9 flex-shrink-0" />
            <div className="w-40">Company</div>
            <div className="w-24 text-right">Price</div>
            <div className="w-32">Buy target</div>
            <div className="w-32">Sell target</div>
            <div className="flex-1 text-center hidden sm:block">Added</div>
